...
public interface BinaryTreeADT<T> {
    ...
    /**
     * Retorna uma referência ao elemento especificado se ele for encontrado neste
     * árvore binária. Lança uma exceção se o elemento especificado não for encontrado.
     *
     * @param targetElement the element being sought in the tree
     * @return a reference to the specified element
     * @throws ed_11_exercicio1.ElementoNaoExisteException
     */
    ...
    /**
     * Executa uma passagem inorder nesta árvore binária chamando um
     * Método inorder sobrecarregado e recursivo que começa com a raiz.
     *
    ...
    /**
     * Executa um percurso pós-ordem nessa árvore binária chamando um
     * Método pós-encomenda recursiva sobrecarregado que começa com a raiz.
     *
     * @return an iterator over the elements of this binary tree
     */
